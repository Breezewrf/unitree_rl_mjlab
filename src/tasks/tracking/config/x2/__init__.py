...
from .env_cfgs import agibot_x2_flat_tracking_env_cfg
from .rl_cfg import agibot_x2_tracking_ppo_runner_cfg

register_mjlab_task(
  task_id="Agibot-X2-Tracking",
...
register_mjlab_task(
  task_id="Agibot-X2-Tracking-No-State-Estimation",
  env_cfg=agibot_x2_flat_tracking_env_cfg(has_state_estimation=False),
  play_env_cfg=agibot_x2_flat_tracking_env_cfg(
